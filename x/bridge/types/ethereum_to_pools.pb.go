...
type ClaimData struct {
	...
	ClaimNonce         uint64                                                           `protobuf:"varint,2,opt,name=claim_nonce,json=claimNonce,proto3" json:"claim_nonce,omitempty"`
	ClaimType          ClaimType                                                        `protobuf:"varint,3,opt,name=claimType,proto3,enum=bridge.v1beta1.ClaimType" json:"claimType,omitempty"`
	EthereumAddresses  []github_com_bloxapp_pools_network_shared_types.EthereumAddress  `protobuf:"bytes,4,rep,name=ethereum_addresses,json=ethereumAddresses,proto3,customtype=github.com/bloxapp/pools-network/shared/types.EthereumAddress" json:"ethereum_addresses,omitempty"`
	ConsensusAddresses []github_com_bloxapp_pools_network_shared_types.ConsensusAddress `protobuf:"bytes,5,rep,name=consensus_addresses,json=consensusAddresses,proto3,customtype=github.com/bloxapp/pools-network/shared/types.ConsensusAddress" json:"consensus_addresses,omitempty"`
	Values             []uint64                                                         `protobuf:"varint,6,rep,packed,name=values,proto3" json:"values,omitempty"`
}
...
func (m *ClaimData) GetClaimNonce() uint64 {
	if m != nil {
		return m.ClaimNonce
	}
	return 0
...
type MsgEthereumClaim struct {
	...
	Data             []ClaimData                                                    `protobuf:"bytes,5,rep,name=data,proto3" json:"data"`
}
...
type ClaimAttestation struct {
	Claim            ClaimData             `protobuf:"bytes,1,opt,name=claim,proto3" json:"claim"`
	Contract         EthereumBridgeContact `protobuf:"bytes,2,opt,name=contract,proto3" json:"contract"`
...
func (m *ClaimAttestation) GetClaim() ClaimData {
	if m != nil {
		return m.Claim
	}
	return ClaimData{}
...
func (m *ClaimAttestation) GetContract() EthereumBridgeContact {
	if m != nil {
		return m.Contract
	}
	return EthereumBridgeContact{}
}
...
var fileDescriptor_1fc670358116c6e3 = []byte{
	...
	,
}
...
func (m *ClaimData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ClaimNonce != 0 {
		i = encodeVarintEthereumToPools(dAtA, i, uint64(m.ClaimNonce))
		i--
		dAtA[i] = 0x10
	}
	if len(m.TxHash) > 0 {
...
func (m *ClaimData) Size() (n int) {
	...
	if m.ClaimNonce != 0 {
		n += 1 + sovEthereumToPools(uint64(m.ClaimNonce))
	}
	if m.ClaimType != 0 {
...
func (m *ClaimData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClaimNonce", wireType)
			}
			m.ClaimNonce = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ClaimNonce |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
